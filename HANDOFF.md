...
- `19f7cbe`에서 [목록 조회·수집 저장 후보 2개](docs/development/backend-api-review.md#목록-조회수집-저장-검토--2026-09-06-미적용)를 추가 확인했다. 정책 목록의 불필요한 상세 본문 변환 제거와 수집 항목 INSERT 배치 적용이며 아직 미적용이다. 이번 검토는 문서만 변경했다.
