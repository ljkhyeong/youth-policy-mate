...
- 최근 검증 명령·로그·실행 범위는 [정책 보정 검증](docs/development/policy-corrections.md#검증)에 있다. 이후 변경은 문서뿐이다. 기존 조건 비교 범위·개인정보 처리는 [개인 조건 탐색](docs/development/condition-policy-discovery.md)을 참고한다.
