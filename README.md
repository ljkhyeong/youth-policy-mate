...
2026-09-05에 **실제 정책 10건의 저장·검색·상세 조회**를 연결했습니다. `/policies`에서 제목·설명을 검색하고 지원 내용·신청 안내·공식 링크·수집 시각을 확인할 수 있습니다. 온통청년 서울 필터의 작은 표본이며 전체 정책 목록이나 개인별 자격 판정은 아닙니다. [실행 방법과 현재 범위](docs/development/policy-catalog.md)를 참고합니다.
