...
2026-09-08 기준 [개인 조건 기반 정책 탐색](docs/development/condition-policy-discovery.md)에서 청년주택드림청약통장을 포함한 5개 정책의 연령을 비교하고 전체 정책에서 검색·정렬합니다. 청약통장은 오늘 가입을 가정한 연령과 병역기간 차감 미확인을 구분합니다. [청년내일저축계좌 신규 가입 질문](docs/development/youth-tomorrow-savings-questions.md) 추가로 질문 제공 범위는 **7개 정책**입니다. 연령 충족과 최종 신청 자격·접수 상태를 구분합니다.
