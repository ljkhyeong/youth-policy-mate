...
2026-09-06에 [개인 조건 기반 정책 탐색](docs/development/condition-policy-discovery.md)을 연결했습니다. 검토된 4개 정책의 연령을 비교하고 전체 정책에서 검색·정렬합니다. [상반기 이사비 지원 질문](docs/development/moving-fee-questions.md) 추가로 질문 제공 범위는 **6개 정책**입니다. 연령 충족과 최종 신청 자격·접수 상태를 구분합니다.
