...
2026-09-08 기준 [개인 조건 기반 정책 탐색](docs/development/condition-policy-discovery.md)에서 햇살론유스를 포함한 7개 정책의 연령을 비교하고 전체 정책에서 검색·정렬합니다. [햇살론유스 조건 질문](docs/development/haetsalron-youth-questions.md) 추가로 질문 제공 범위는 **9개 정책**입니다. 연령·이용 대상·소득·남은 생애 보증한도를 확인하며 실제 보증·대출 승인과 이용 조건은 별도 심사로 남깁니다. [전세보증금반환보증 보증료 지원](docs/development/guarantee-fee-questions.md)의 보증 가입·납부, 보증금·무주택·유형별 소득 질문도 제공합니다.
