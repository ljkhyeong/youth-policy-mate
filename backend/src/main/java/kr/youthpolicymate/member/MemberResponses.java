...
public final class MemberResponses {
    ...
    @Schema(name = "SavedPolicy", requiredProperties = {"policyNumber", "title", "savedRevision", "currentRevision", "deadline", "savedAt", "applicationPeriod"})
    public record Saved(String policyNumber, String title, long savedRevision, long currentRevision,
                        PolicyDeadline deadline, Instant savedAt, String applicationPeriod) {}
